...
*/
	...
	player createDiaryRecord["changelog",
		[
			"Custom Change Log",
				"
					Visit the website. Many updates coming weekly, DO NOT REMOVE THE ABOVE.
				"
		]
	];
	...
	player createDiaryRecord ["serverrules",
		[
			"Cop Interaction", 
				...
				1. Civilians can be arrested for looking in cops' backpacks/vehicles. Constantly doing this will result in your removal from the server. Search your bag away from them. Checking your own inventory near them will get your arrested.<br/>
	...
	player createDiaryRecord ["serverrules",
		[
			"New Life Rule", 
				"
				The New Life Rule applies to the civilians.<br/><br/>
				
				Items on this list may result in your removal from the server and/or ban, based on the admins discretion.<br/><br/>

				1. If you are killed you must wait 15 minutes before returning to the scene of your death, its not a new<br/>
				2. If you die by a cop your past crimes are forgotten, but you also cannot seek revenge.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"City Protocol", 
				...
				3. Officers may stand around or loiter in the centre of town.<br/>
				...
				5. Martial law may not be declared at any time. Unless ordered by a high ranking officer<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Arresting and Ticketing",
				...
				The list is available at www.CWYAltisLife.us<br/><br/>
				"
		]
	];
